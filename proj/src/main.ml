let () =
  ...
  @@ Dream.router
       [
         ...
         (Dream.get "/projetos/0/adicionar" @@ fun a -> Handlers.add_project a None);
         ...
         Dream.post "/projetos/:id/novapublicacao" @@ Handlers.add_publication_form;
         (* Contratos *)
         ...
         ( Dream.get "/unidades/:id/remover" @@ fun a ->
           Handlers.delete_unid a);
         (* Institutos *)
